# This file should replace client.py in 
#/sysroot/usr/lib/python3.8/site-packages/paho/mqtt/client.py
...
class Client(object):
    ...
    * Use disconnect() to disconnect from the broker
    ...
    def _packet_queue(self, command, packet, mid, qos, info=None):
        ...
        #import inspect;print("--- ", (inspect.getframeinfo(inspect.currentframe())).filename, (inspect.getframeinfo(inspect.currentframe())).lineno, " return MQTT_ERR_SUCCESS")
        self._call_socket_register_write()
        #import inspect;print("--- ", (inspect.getframeinfo(inspect.currentframe())).filename, (inspect.getframeinfo(inspect.currentframe())).lineno, " return MQTT_ERR_SUCCESS")
        return MQTT_ERR_SUCCESS
